    ...
    <div className="space-y-6 sm:space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20 md:pb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-2">
        ...
        >
          ...
          <div className={`text-xl sm:text-2xl font-black ${isLight ? 'text-slate-900' : 'text-white'}`}>
            {hasProAccess ? copy.mails : copy.pro}
          </div>
          <p className={`text-[10px] font-bold mt-1 ${hasProAccess ? 'text-emerald-600' : 'text-amber-600'}`}>
            {hasProAccess ? copy.active : copy.unlockWithPro}
          </p>
        </div>
        ...
        >
          ...
          <div className={`text-xl sm:text-2xl font-black ${isLight ? 'text-slate-900' : 'text-white'}`}>
            {hasProAccess ? copy.aiTools : copy.pro}
          </div>
          <p className={`text-[10px] font-bold mt-1 ${hasProAccess ? 'text-indigo-600' : 'text-amber-600'}`}>
            {hasProAccess ? copy.ready : copy.proRequired}
          </p>
        </div>
      </div>
    </div>
