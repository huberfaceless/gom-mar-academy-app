...
const checks: Array<[boolean, string]> = [
  ...
  [academy.includes('requestedInitialStageId <= stageAccessLimit') && !academy.includes('unlockedStageIdSet'), 'Administratoren können Entwürfe unabhängig von der Mitglieder-Freischaltung direkt öffnen.'],
